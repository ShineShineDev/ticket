    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        complicated for users of screen readers and related
        ...
        <CCol :lg="6">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add any of the below-mentioned <code>color</code> props
                        to modify the presentation of a badge.
                    </p>
                    <DocsExample
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Apply the <code>shape=&#34;rounded-pill&#34;</code> prop
                        to make badges rounded.
                    </p>
