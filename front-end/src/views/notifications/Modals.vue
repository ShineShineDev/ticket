    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        (optional). We ask that you include modal headers with
                        dismiss actions whenever possible, or provide another
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        If you set <code>backdrop</code> property to
                        <code>static</code>, your modal will behave as though
                        the backdrop is static, meaning it will not close when
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        modals as needed. When modals are closed, any tooltips
                        and popovers within are also automatically dismissed.
                    </p>
                    <DocsExample
                                ...
                                <p>
                                    ...
                                    <CButton
                                        v-c-popover="{
                                            ...
                                            content:
                                                'Popover body content is set in this property.',
                                        }"
                                        color="secondary"
                                        >button</CButton
                                    >
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        covers the user viewport, available via property
