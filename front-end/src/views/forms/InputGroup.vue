            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        within will automatically resize—no need for repeating
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        supported visually, validation styles are only available
                        for input groups with a single
                        <code>&lt;CFormInput&gt;</code>.
                    </p>
                    <DocsExample href="forms/input-group.html#multiple-inputs">
                        <CInputGroup>
                            <CInputGroupText
                                >First and last name</CInputGroupText
                            >
