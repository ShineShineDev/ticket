            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        associated <code>&lt;label&gt;</code>s are automatically
                        styled to match with a lighter color to help indicate
                        the input&#39;s state.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        the
                        <code>switch</code> boolean properly to render a toggle
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CFormCheck&gt;</code> component. These toggle
                        buttons can further be grouped in a button group if
                        needed.
                    </p>
