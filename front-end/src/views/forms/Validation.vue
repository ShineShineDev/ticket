    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        For custom CoreUI form validation messages, you&#39;ll
                        need to add the
                        <code>novalidate</code> boolean property to your
                        <code>&lt;CForm&gt;</code>. This disables the browser
                        default feedback tooltips, but still provides access to
                        the form validation APIs in JavaScript. Try to submit
                        the form below; our JavaScript will intercept the submit
                        button and relay feedback to you. When attempting to
                        submit, you&#39;ll see the <code>:invalid</code> and
                        <code>:valid</code> styles applied to your form
                        controls.
                    </p>
                    <p class="text-medium-emphasis small">
                        Custom feedback styles apply custom colors, borders,
                        focus styles, and background icons to better communicate
                        feedback.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        form below. Depending on your browser and OS, you&#39;ll
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        feedback/error message is associated with the relevant
                        form field using
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        If your form layout allows it, you can swap the text for
                        the tooltip to display validation feedback in a styled
                        tooltip. Be sure to have a parent with
