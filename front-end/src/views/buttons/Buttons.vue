    ...
    <CRow>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        The <code>&lt;CButton&gt;</code> component are designed
                    ...
                    <p class="text-medium-emphasis small">
                        If you&#39;re using
                        <code>&lt;CButton&gt;</code> component as
                        <code>&lt;a&gt;</code> elements that are used to trigger
                        functionality ex. collapsing content, these links should
                        be given a <code>role=&#34;button&#34;</code> to
                        adequately communicate their meaning to assistive
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        If you need a button, but without the strong background
                        colors. Set
                        <code>variant=&#34;outline&#34;</code> prop to remove
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>variant=&#34;ghost&#34;</code> prop to remove all
                        background colors.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CButton&gt;</code>
                        component to make buttons look inactive. Disabled button
                        has
                        <code>pointer-events: none</code> applied to, disabling
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;a&gt;</code> component act a little different:
                    </p>
                    <p class="text-medium-emphasis small">
                        <code>&lt;a&gt;</code>s don&#39;tsupport the
                        <code>disabled</code> attribute, so CoreUI has to add
                        <code>.disabled</code> class to make buttons look
                        inactive. CoreUI also has to add to the disabled button
                        component
                        <code>aria-disabled=&#34;true&#34;</code> attribute to
                        show the state of the component to assistive
                        technologies.
                    </p>
                    <DocsExample href="components/button.html#disabled-state">
                        <CButton
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Create buttons that span the full width of a parent—by
                        using utilities.
                    </p>
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        vertically stacked buttons until the
                        <code>md</code> breakpoint, where
                        <code>.d-md-block</code> replaces the
                        <code>.d-grid</code> class, thus nullifying the
                        <code>gap-2</code> utility. Resize your browser to see
                        them change.
                    </p>
                    <DocsExample href="components/button.html#block-buttons">
                    ...
                    <p class="text-medium-emphasis small">
                        You can adjust the width of your block buttons with grid
                        column width classes. For example, for a half-width
                        &#34;block button&#34;, use <code>.col-6</code>. Center
                        it horizontally with <code>.mx-auto</code>, too.
                    </p>
                    <DocsExample href="components/button.html#block-buttons">
                    ...
                    <p class="text-medium-emphasis small">
                        Additional utilities can be used to adjust the alignment
                        of buttons when horizontal. Here we&#39;ve taken our
                        previous responsive example and added some flex
                        utilities and a margin utility on the button to right
                    ...
                    <DocsExample href="components/button.html#block-buttons">
                        ...
                        >
                            <CButton color="primary" class="me-md-2">
                                Button
                            </CButton>
                            <CButton color="primary">Button</CButton>
                        </div>
