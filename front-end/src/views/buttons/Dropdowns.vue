            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        addition of boolean prop <code>split</code> for proper
                        spacing around the dropdown caret.
                    </p>
                    <p class="text-medium-emphasis small">
                        We use this extra class to reduce the horizontal
                        <code>padding</code> on either side of the caret by 25%
                        and remove the <code>margin-left</code> that&#39;s
                        attached for normal button dropdowns. Those additional
                        changes hold the caret centered in the split button and
                        implement a more properly sized hit area next to the
                        main button.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        custom style by set
                        <code>dark</code> property. No changes are required to
                        the dropdown items.
                    </p>
