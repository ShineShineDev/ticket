    ...
    <CRow>
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        Wrap a series of <code>&lt;CButton&gt;</code> components
                        in <code>&lt;CButtonGroup&gt;</code>.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        Combine button-like checkbox and radio toggle buttons
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        ...
                        complicated components. Use utility classes as needed to
                    ...
                    <p>
                        Feel free to combine input groups with button groups in
                        your toolbars. Similar to the example above, you’ll
                        likely need some utilities through to space items
                        correctly.
                    </p>
                    <DocsExample
                        href="components/button-group.html#button-toolbar"
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        Alternatively, of implementing button sizing classes to
                        each button in a group, set
                        <code>size</code> property to all
                        <code>&lt;CButtonGroup&gt;</code>&#39;s, including each
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CButtonGroup&gt;</code> when you need dropdown
                        menus combined with a series of buttons.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Create a set of buttons that appear vertically stacked
                        rather than horizontally.
                        <strong
                            >Split button dropdowns are not supported
                            here.</strong
                        >
                    </p>
                    <DocsExample
