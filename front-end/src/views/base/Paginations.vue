            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        some pagination links? Be sure to provide proper screen
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;a&gt;</code>s, that CSS property is not yet
                        standardized and doesn&#39;taccount for keyboard
                        navigation. As such, we always add
                        <code>tabindex=&#34;-1&#34;</code> on disabled links and
                        use custom JavaScript to fully disable their
                        functionality.
                    </p>
                    <DocsExample
