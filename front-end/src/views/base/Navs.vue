    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        flexbox and provide a strong foundation for building all
                        types of navigation components. It includes some style
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;ol&gt;</code> if the order of your items is
                        important, or roll your own with a
                        <code>&lt;nav&gt;</code> element. Because the .nav uses
                        display: flex, the nav links behave the same as nav
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        . By default, navs are left-aligned, but you can easily
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        direction with the{' '}
                        <code>.flex-column</code> utility. Need to stack them on
                        some viewports but not others? Use the responsive
                        versions (e.g., <code>.flex-sm-column</code>).
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>variant=&#34;tabs&#34;</code> class to generate a
                        tabbed interface
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Force your <code>.nav</code>&#39;s contents to extend
                        the full available width one of two modifier classes. To
                        proportionately fill all available space with your
                        <code>.nav-item</code>s, use
                        <code>layout=&#34;fill&#34;</code>. Notice that all
                        horizontal space is occupied, but not every nav item has
                        the same width.
                    </p>
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>layout=&#34;justified&#34;</code>. All horizontal
                        space will be occupied by nav links, but unlike the
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        breakpoint, then adapt to a horizontal layout that fills
