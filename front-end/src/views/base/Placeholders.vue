    ...
    <CRow>
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        and recreate it with placeholders applied to create a
                        "loading card". Size and proportions are the same
                        between the two.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        ...
                        <code>&lt;CPlaceholder&gt;</code> component and a grid
                        column propx (e.g., <code>:xs="6"</code>) to set the
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p>
                        The size of <code>&lt;CPlaceholder&gt;</code>s are based
                        on the typographic style of the parent element.
                        Customize them with <code>size</code> prop:
