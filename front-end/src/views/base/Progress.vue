    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        some CSS to set the width, and a few attributes. We
                        don&#39;tuse
                        <a
                        ...
                        , ensuring you can stack progress bars, animate them,
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CProgress&gt;</code>, so if you change that
                        value the inner <code>&lt;CProgressBar&gt;</code> will
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Use <code>color</code> prop to change the appearance of
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CProgressBar&gt;</code> to apply a stripe via
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CProgressBar&gt;</code> to animate the stripes
