    ...
    <CRow>
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    ...
                    <p class="text-medium-emphasis small">
                        The border spinner uses <code>currentColor</code> for
                        its <code>border-color</code>. You can use any of our
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        If you don&#39;tfancy a border spinner, switch to the
                        grow spinner. While it doesn&#39;t technically spin, it
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>currentColor</code>, so you can easily change its
                        appearance. Here it is in blue, along with the supported
                        variants.
                    </p>
                    <DocsExample href="components/spinner.html#growing-spinner">
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>size=&#34;sm&#34;</code> property to make a
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        currently processing or taking place. You may also swap
                        the text out of the spinner element and utilize button
                        text as needed.
                    </p>
