    ...
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        possible but still manage to deliver a bunch of control
                        and customization. Built with flexbox, they offer easy
                        alignment and mix well with other CoreUI components.
                        Cards have no top, left, and right margins by default,
                        so use
                    ...
                    <p class="text-medium-emphasis small">
                        Below is an example of a basic card with mixed content
                        and a fixed width. Cards have no fixed width to start,
                        so they&#39;ll naturally fill the full width of its
                        parent element.
                    </p>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CCardBody&gt;</code>. Use it whenever you need
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CCardTitle&gt;</code> component. Identically,
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CCardBody&gt;</code> item, the card title, and
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        <code>.card-img-top</code> places a picture to the top
                        of the card. With <code>.card-text</code>, text can be
                        added to the card. Text within
                        <code>.card-text</code> can additionally be styled with
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Combine and match many content types to build the card
                        you need, or throw everything in there. Shown below are
                        image styles, blocks, text styles, and a list group—all
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        they&#39;ll be 100% wide unless otherwise stated. You
                        can adjust this as required with custom CSS, grid
                        ...
                        <CRow>
                            <CCol :sm="6">
                                <CCard>
                                    <CCardBody>
                                        <CCardTitle
                                            >Special title treatment</CCardTitle
                                        >
                                        <CCardText>
                    ...
                    <p class="text-medium-emphasis small">
                        Use custom CSS in your stylesheets or as inline styles
                        to set a width.
                    </p>
                    <DocsExample href="components/card.html/#sizing">
                        <CCard style="width: 18rem">
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        and bottom &#34;image caps&#34;—images at the top or
                        bottom of a card.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    ...
                    <p class="text-medium-emphasis small">
                        Use <code>color</code> property to change the appearance
                        of a card.
                    </p>
                    <DocsExample
                    ...
                    <p class="text-medium-emphasis small">
                        ...
                        <a href="https://coreui.io/docs/utilities/borders/"
                            >border utilities</a
                        >
                        to change just the <code>border-color</code> of a card.
                        Note that you can set <code>text-color</code> property
                        on the <code>&lt;CCard&gt;</code> or a subset of the
                    ...
                    <DocsExample href="components/card.html/#border">
                        ...
                        >
                            ...
                            >
                                ...
                                <CCardBody>
                                    <CCardTitle
                                        >{{ item.color }} card title</CCardTitle
                                    >
                                    <CCardText
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        element with equal width and height columns. Card groups
                        start off stacked and use <code>display: flex;</code> to
