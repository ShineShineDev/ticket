    ...
    <CRow>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Use <code>striped</code> property to add zebra-striping
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Use <code>hover</code> property to enable a hover state
                        on table rows within a <code>&lt;CTableBody&gt;</code>.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>bordered</code> property for borders on all
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                <CCardHeader>
                    <strong>Vue Table</strong>
                    <small>Tables without borders</small>
                </CCardHeader>
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>borderless</code> property for a table without
                        borders.
                    </p>
                    <DocsExample
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CTable&gt;</code> more compact by cutting all
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        always vertical aligned to the bottom. Table cells in
                        <code>&lt;CTableBody&gt;</code> inherit their alignment
                        from <code>&lt;CTable&gt;</code> and are aligned to the
                        the top by default. Use the align property to re-align
                        where needed.
                    </p>
                    <DocsExample
                            ...
                            <CTableBody>
                                <CTableRow>
                                    ...
                                    <CTableDataCell>
                                        ...
                                        vertical space, to demonsCTableRowate
                                        how the vertical alignment works in the
                                        preceding cells.
                                    </CTableDataCell>
                                </CTableRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CTableHead&gt;</code>s appear light or dark
                        gray.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        A <code>&lt;CTableCaption&gt;</code> functions like a
                        heading for a table. It helps users with screen readers
                        to find a table and understand what it&#39;s about and
