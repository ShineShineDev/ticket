<template>
    <CRow>
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        The default list group is an unordered list with items
                        and the proper CSS classes. Build upon it with the
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>&lt;CListGroupItem&gt;</code> to show the current
                        active selection.
                    </p>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                <CCardHeader>
                    <strong>Vue List Group</strong>
                    <small>Disabled items</small>
                </CCardHeader>
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>disabled</code> boolean property to a
                        <code>&lt;CListGroupItem&gt;</code> to make it appear
                        disabled.
                    </p>
                    <DocsExample
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        <code>component=&#34;a|button&#34;</code>. We separate
                        these pseudo-classes to ensure list groups made of
                        non-interactive elements (like <code>&lt;li&gt;</code>s
                        or
                        <code>&lt;div&gt;</code>
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>flush</code> boolean property to remove some
        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        Add <code>layout=&#34;horizontal&#34;</code> to change
                        the layout of list group items from vertical to
                        horizontal across all breakpoints. Alternatively, choose
            ...
            <CCard class="mb-4">
                ...
                <CCardBody>
                    <p class="text-medium-emphasis small">
                        ...
                        like the one below, with the help of
