        ...
        <div class="bg-white p-2 rounded mt-3 px-md-5 p-2 py-3">
            <form @submit.prevent="submitForm">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-6">
                        <input v-model="departureDate" class="form-control form-control-sm" id="departureDate"
                            type="date" />
                    </div>
                </div>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select v-if="!fetchLoading" @change="updateSelectedBus" class="form-control form-control-sm"
                            ...
                            <option v-for="busItem in bus" :key="busItem.id" :value="busItem.id">{{ busItem.busNumber }}
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-6">
                        <select v-if="!fetchLoading" @change="updateSelectedRoute" class="form-control form-control-sm"
                            ...
                            <option v-for="way in ways" :key="way.id" :value="way.id">{{ way.departureLocation }}
                                to {{ way.arrivalLocation }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        <button type="submit" :disabled="isSubmitDisabled" class="btn btn-sm btn-primary" style="">
                            ...
                            <i v-if="!isSubmitDisabled" class="bi bi-check"></i> Submit</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    methods: {
        async submitForm() {
            try {
                ...
                // Optionally, reset form fields and navigate to another route
